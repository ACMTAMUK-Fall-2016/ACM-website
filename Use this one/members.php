...
<!--Join Now Slide-->
 ...
 <img class="member2" style="height:160px;width:auto;" src='<?php if(isset($_GET['mem'])){echo "images/members/" . $num;}else{echo "images/faculty/" . $num;} ?>.jpg' alt='<?php echo $member_name ?>' title='<?php echo $member_name ?>'> 
